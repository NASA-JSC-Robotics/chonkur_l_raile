...
class ChonkurControllerStopper(ControllerStopperBase):
    ...
    def __init__(self):
        ...
        self.get_program_state_srv = self.create_client(GetProgramState,'/ur_dashboard_client/get_program_state')
    ...
    def timer_callback(self):
        ...
        future = self.get_program_state_srv.call_async(request)
        ...
        def callback(future):
            ...
            self.robot_running = future.result().state.state == ProgramState.PLAYING
