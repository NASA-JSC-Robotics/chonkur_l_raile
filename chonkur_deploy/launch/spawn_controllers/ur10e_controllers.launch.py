...
def generate_launch_description():
    ...
    # active controllers
    nodes.append(spawn_controller("io_and_status_controller", namespace=ns))
    ...
    admittance_controller_spawner = spawn_controller(
        "admittance_controller", namespace=ns, condition=IfCondition(enable_admittance)
    )
    admittance_jtc_spawner = spawn_controller(
        "admittance_joint_trajectory_controller", namespace=ns, condition=IfCondition(enable_admittance)
    )
