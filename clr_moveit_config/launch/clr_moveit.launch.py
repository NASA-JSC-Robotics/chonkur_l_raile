...
def generate_launch_description():
    ...
    description_package = 'chonkur_description'
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="chonkur_raile.urdf.xacro",
            # default_value="raile.urdf.xacro",
            # default_value="liftkit.urdf.xacro",
    ...
    # description_file = "raile.urdf.xacro"
    ...
    moveit_config_package = 'temp_chonkur_moveit'
    moveit_config_file = 'chonkur.srdf.xacro'
